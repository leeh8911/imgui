...
struct ImGuiLayoutItem
{
    ...
    {
        Type = type;
        MeasuredBounds = ImRect(0, 0, 0, 0); // FIXME: @thedmd are you sure the default ImRect value
...
struct ImGuiContext
{
    ...
    float HoverDelayTimer;      // Currently used IsItemHovered(), generally inferred from g.HoveredIdTimer but kept
